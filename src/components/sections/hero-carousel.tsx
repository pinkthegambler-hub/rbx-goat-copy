              ...
              <Link href={slide.href} target={slide.href.startsWith("http") ? "_blank" : "_self"} rel="noopener noreferrer" className="!w-[123%] !h-[284px]">
                <div className="h-[200px] sm:h-[256px] lg:h-[224px] rounded-lg bg-white/10 overflow-hidden transition-all duration-300 ease-in-out hover:brightness-110 !w-[334px] 2xl:!h-full">
                  <div className="flex items-center justify-center min-w-full aspect-[1.7625] overflow-hidden !w-full !h-[223px]">
                    ...
                    width={423}
                    height={240}
                    className="object-cover transition-transform duration-300 ease-in-out group-hover:scale-105 !block !bg-none !bg-cover !bg-center !bg-none !bg-cover !bg-center !bg-none !bg-cover !bg-center !bg-slate-800 !grid !w-[319px] !h-[252px] !max-w-[319px]"
                    priority={index < 3} />
