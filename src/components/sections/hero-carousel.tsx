        ...
        <CarouselContent className="-ml-4">
          ...
          <CarouselItem
            ...
            className="min-w-0 shrink-0 grow-0 basis-full pl-4 lg:basis-1/2 2xl:basis-1/3">
              ...
              <Link href={slide.href} target={slide.href.startsWith("http") ? "_blank" : "_self"} rel="noopener noreferrer" className="!w-[154px] !h-full">
                <div className="h-[200px] sm:h-[256px] lg:h-[224px] rounded-lg bg-white/10 overflow-hidden transition-all duration-300 ease-in-out hover:brightness-110 !w-[334px] 2xl:!h-full">
                  <div className="flex items-center justify-center min-w-full aspect-[1.7625] overflow-hidden !w-full !h-full">
                    <Image
                    src={slide.src}
                    alt={slide.alt}
                    width={423}
                    height={240}
                    className="object-cover transition-transform duration-300 ease-in-out group-hover:scale-105 !block !bg-none !bg-cover !bg-center !bg-none !bg-cover !bg-center !bg-none !bg-cover !bg-center !bg-slate-800 !grid !w-[68.1%] !h-[202px] !max-w-[68.1%]"
                    priority={index < 3} />
